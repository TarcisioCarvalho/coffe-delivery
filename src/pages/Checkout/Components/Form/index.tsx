...
export const Form = () => {
  ...
  const {cep,updateCep,endereco,numero,changeEnderecoWithNumber} = React.useContext(AddressContext);
  ...
  return (
    <FormContainer>
           ...
           <Input placeholder = 'Número' value ={numero} updateCep={changeEnderecoWithNumber} sizeProps ='25%'/>
